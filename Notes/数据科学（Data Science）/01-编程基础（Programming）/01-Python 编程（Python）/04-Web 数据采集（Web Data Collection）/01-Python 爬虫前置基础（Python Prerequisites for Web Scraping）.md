---
title: 01-Python 爬虫前置基础（Python Prerequisites for Web Scraping）
tags:
  - python/web-scraping/prerequisites
status: published
...
print(s[2:4])  # 黎明；从索引 2 开始，到索引 4 之前结束
```
...
# 注意, 如果列表中没有数据. 取0会报错
lst = []
print(lst[0])  # 抛出 IndexError: list index out of range

# 注意, 如果给出的索引下标超过了列表的最大索引. 依然会报错
lst = ["123", "456"]
print(lst[9999])  # 抛出 IndexError: list index out of range
...
download_image("http://www.baidu.com/abc/huyifei.jpg", "胡二飞.jpg")
download_image("http://www.baidu.com/aaa/dagedagefeifeifei.jpg", "大哥大哥飞飞飞.jpg")
# 期望输出:
# 我要下载图片http://www.baidu.com/abc/huyifei.jpg了 保存在胡二飞.jpg
# 我要下载图片http://www.baidu.com/aaa/dagedagefeifeifei.jpg了 保存在大哥大哥飞飞飞.jpg
...
print(i)  # 输出为 1 到 10（含边界）之间的随机整数，例如 7
```
