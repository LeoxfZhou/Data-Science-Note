---
title: 机房预约系统（Computer Room Reservation System）
status: published
project_type: system-example
published_at: 2026-08-17
updated_at: 2026-08-17
---
# 机房预约系统（Computer Room Reservation System）
> [!tip] 学习目标（Learning Objective）
> 以学生、教师、管理员三种角色演示继承、多态登录、文件数据加载、预约状态流转与权限分工。真实认证系统不能保存明文凭据，也不能只依赖本地文本文件实现访问控制。
