---
title: 演讲比赛流程管理系统（Speech Contest Workflow System）
status: published
project_type: system-example
published_at: 2026-08-17
updated_at: 2026-08-17
---
# 演讲比赛流程管理系统（Speech Contest Workflow System）
> [!tip] 学习目标（Learning Objective）
> 使用 STL 容器、随机打乱、排序、分组晋级和 CSV 风格记录实现完整比赛流程。重点理解容器选择、评分状态变化、持久化和历史记录清理，而不是只复制菜单代码。
