---
title: "Gensim 词典、词袋与 TF-IDF（Gensim Dictionary, BoW, and TF-IDF）"
tags:
  - data-science/nlp/gensim
status: published
created: 2026-08-12
published_at: 2026-08-12
---
# Gensim 词典、词袋与 TF-IDF（Gensim Dictionary, BoW, and TF-IDF）
> [!tip] 大白话理解（Plain-language Intuition）
> 词典（Dictionary）先给每个词分配稳定编号；词袋（Bag of Words, BoW）只记录“哪个编号出现了几次”，不保留词序；词频-逆文档频率（Term Frequency-Inverse Document Frequency, TF-IDF）再降低“到处都有的常见词”权重，提高“在当前文档突出但全语料较少见的词”权重。训练和推理若使用不同词典编号，向量相同位置会代表不同词，结果就失去意义。
## 概念速查表
