---
title: "循环神经网络、词嵌入与文本生成（RNN, Word Embedding, and Text Generation）"
tags:
  - data-science/nlp/rnn
status: published
created: 2026-08-12
published_at: 2026-08-12
---
# 循环神经网络、词嵌入与文本生成（RNN, Word Embedding, and Text Generation）
> [!tip] 大白话理解（Plain-language Intuition）
> 普通前馈网络（Feedforward Network）每次只看当前输入；循环神经网络（Recurrent Neural Network, RNN）还把上一步的隐藏状态（Hidden State）带到下一步，像一边读句子一边保留“读到这里的摘要”。通过时间的反向传播（Backpropagation Through Time, BPTT）则把同一个循环在时间轴上展开，再从最后一步往前追责；序列太长时，梯度反复相乘就容易消失或爆炸。
## 循环神经网络RNN
### RNN介绍
#### RNN概念
...
![[01-循环神经网络、词嵌入与文本生成（RNN, Word Embedding, and Text Generation）-1734745895344.png]]
...
![[01-循环神经网络、词嵌入与文本生成（RNN, Word Embedding, and Text Generation）-1734746204314.png]]
