---
title: "带注意力的 Seq2Seq 英法翻译实践（Attention-based Seq2Seq Translation Practice）"
tags:
  - data-science/nlp
status: published
created: 2026-08-13
...
---
# 带注意力的 Seq2Seq 英法翻译实践（Attention-based Seq2Seq Translation Practice）
...
![[Attachments/Notes/数据科学（Data Science）/03-深度学习（Deep Learning）/04-自然语言处理（Natural Language Processing）/05-项目实践（Projects）/03-注意力 Seq2Seq 机器翻译（Attention Seq2Seq Translation）/03-注意力 Seq2Seq 机器翻译（Attention Seq2Seq Translation）-20260813120000084.png]]
...
#### 3 构建基于GRU的编码器（Encoder）和解码器
> [!tip] 大白话理解（Plain-language Intuition）
> GRU 把 LSTM 的若干开关合并成更简洁的更新规则：参数更少、计算更轻，但仍能决定旧信息保留多少、新信息写入多少。
##### 1 构建基于GRU的编码器（Encoder）

- 编码器结构图:

![[Attachments/Notes/数据科学（Data Science）/03-深度学习（Deep Learning）/04-自然语言处理（Natural Language Processing）/05-项目实践（Projects）/03-注意力 Seq2Seq 机器翻译（Attention Seq2Seq Translation）/03-注意力 Seq2Seq 机器翻译（Attention Seq2Seq Translation）-20260813120000083.png]]
...
##### 2 构建基于GRU的解码器（Decoder）

- 解码器结构图:

![[Attachments/Notes/数据科学（Data Science）/03-深度学习（Deep Learning）/04-自然语言处理（Natural Language Processing）/05-项目实践（Projects）/03-注意力 Seq2Seq 机器翻译（Attention Seq2Seq Translation）/03-注意力 Seq2Seq 机器翻译（Attention Seq2Seq Translation）-20260813120000082.png]]
...
##### 3 构建基于GRU和Attention的解码器（Decoder）
> [!tip] 大白话理解（Plain-language Intuition）
> 注意力机制像读长文时移动聚光灯：生成当前结果时，不平均依赖所有输入，而是根据当前查询把更高权重放到更相关的位置。权重表示当前计算中的相关程度，不等同于严格因果解释。

- 解码器结构图:

![[Attachments/Notes/数据科学（Data Science）/03-深度学习（Deep Learning）/04-自然语言处理（Natural Language Processing）/05-项目实践（Projects）/03-注意力 Seq2Seq 机器翻译（Attention Seq2Seq Translation）/03-注意力 Seq2Seq 机器翻译（Attention Seq2Seq Translation）-20260813120000081.png]]
...
![[Attachments/Notes/数据科学（Data Science）/03-深度学习（Deep Learning）/04-自然语言处理（Natural Language Processing）/05-项目实践（Projects）/03-注意力 Seq2Seq 机器翻译（Attention Seq2Seq Translation）/03-注意力 Seq2Seq 机器翻译（Attention Seq2Seq Translation）-20260813120000086.png]]
...
![[Attachments/Notes/数据科学（Data Science）/03-深度学习（Deep Learning）/04-自然语言处理（Natural Language Processing）/05-项目实践（Projects）/03-注意力 Seq2Seq 机器翻译（Attention Seq2Seq Translation）/03-注意力 Seq2Seq 机器翻译（Attention Seq2Seq Translation）-20260813120000085.png]]
