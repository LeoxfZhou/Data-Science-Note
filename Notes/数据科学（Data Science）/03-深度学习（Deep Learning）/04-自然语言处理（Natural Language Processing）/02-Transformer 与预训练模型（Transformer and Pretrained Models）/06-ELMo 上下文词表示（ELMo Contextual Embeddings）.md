---
title: "ELMo 上下文词表示（ELMo Contextual Word Representations）"
tags:
  - data-science/nlp
status: published
created: 2026-08-13
...
---
# ELMo 上下文词表示（ELMo Contextual Word Representations）
...
![[Attachments/Notes/数据科学（Data Science）/03-深度学习（Deep Learning）/04-自然语言处理（Natural Language Processing）/02-Transformer 与预训练模型（Transformer and Pretrained Models）/06-ELMo 上下文词表示（ELMo Contextual Embeddings）/06-ELMo 上下文词表示（ELMo Contextual Embeddings）-20260813120000157.png]]
...
![[Attachments/Notes/数据科学（Data Science）/03-深度学习（Deep Learning）/04-自然语言处理（Natural Language Processing）/02-Transformer 与预训练模型（Transformer and Pretrained Models）/06-ELMo 上下文词表示（ELMo Contextual Embeddings）/06-ELMo 上下文词表示（ELMo Contextual Embeddings）-20260813120000158.png]]
