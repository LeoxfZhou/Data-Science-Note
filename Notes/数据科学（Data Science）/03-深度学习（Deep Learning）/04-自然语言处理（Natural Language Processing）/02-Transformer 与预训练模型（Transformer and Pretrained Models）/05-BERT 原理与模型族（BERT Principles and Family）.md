---
title: "BERT 预训练任务、输入表示与模型变体（BERT Pretraining, Inputs, and Variants）"
tags:
  - data-science/nlp
status: published
created: 2026-08-13
...
---
# BERT 预训练任务、输入表示与模型变体（BERT Pretraining, Inputs, and Variants）
...
![[Attachments/Notes/数据科学（Data Science）/03-深度学习（Deep Learning）/04-自然语言处理（Natural Language Processing）/02-Transformer 与预训练模型（Transformer and Pretrained Models）/05-BERT 原理与模型族（BERT Principles and Family）/05-BERT 原理与模型族（BERT Principles and Family）-20260813120000154.png]]
...
![[Attachments/Notes/数据科学（Data Science）/03-深度学习（Deep Learning）/04-自然语言处理（Natural Language Processing）/02-Transformer 与预训练模型（Transformer and Pretrained Models）/05-BERT 原理与模型族（BERT Principles and Family）/05-BERT 原理与模型族（BERT Principles and Family）-20260813120000155.png]]
...
![[Attachments/Notes/数据科学（Data Science）/03-深度学习（Deep Learning）/04-自然语言处理（Natural Language Processing）/02-Transformer 与预训练模型（Transformer and Pretrained Models）/05-BERT 原理与模型族（BERT Principles and Family）/05-BERT 原理与模型族（BERT Principles and Family）-20260813120000156.png]]
...
![[Attachments/Notes/数据科学（Data Science）/03-深度学习（Deep Learning）/04-自然语言处理（Natural Language Processing）/02-Transformer 与预训练模型（Transformer and Pretrained Models）/05-BERT 原理与模型族（BERT Principles and Family）/05-BERT 原理与模型族（BERT Principles and Family）-20260813120000153.png]]
...
> [!warning] 源站附件缺失（Missing Source Attachment）：`./img/7_1_3.png`

---

- 最后预测Span中原词的时候会得到一个损失, 这就是SBO任务的损失; 再将其和BERT自身的MLM任务的损失进行加和, 共同作为SpanBERT的目标损失函数进行训练:

> [!warning] 源站附件缺失（Missing Source Attachment）：`./img/7_1_4.png`
