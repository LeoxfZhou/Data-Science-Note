...
- [[#_1|学习目标]]
- [[#1-decoder|1 Decoder端的输入解析]]
    
	- [[#11-decoder|1.1 Decoder端的架构]]
	- [[#12-decoder|1.2 Decoder在训练阶段的输入解析]]
	- [[#13-decoder|1.3 Decoder在预测阶段的输入解析]]
...
## 1 Decoder端的输入解析[[#1-decoder|¶]]

### 1.1 Decoder端的架构[[#11-decoder|¶]]
...
### 1.2 Decoder在训练阶段的输入解析[[#12-decoder|¶]]
...
### 1.3 Decoder在预测阶段的输入解析[[#13-decoder|¶]]
