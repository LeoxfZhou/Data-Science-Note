...
- [[#2-bertmlm|2 BERT的MLM任务]]
    
	- [[#21-bertmlm80-10-10|2.1 BERT的MLM任务中为什么采用了80%, 10%, 10%的策略?]]
    
- [[#3-bert|3 BERT处理长文本的方法]]
- [[#4|4 小结]]
...
## 2 BERT的MLM任务[[#2-bertmlm|¶]]

### 2.1 BERT的MLM任务中为什么采用了80%, 10%, 10%的策略?[[#21-bertmlm80-10-10|¶]]
