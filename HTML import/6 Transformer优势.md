...
- [[#_1|学习目标]]
- [[#1-transformer|1 Transformer的并行计算]]
- [[#2-transformer|2 Transformer架构的并行化过程]]
    
	- [[#21-transformerencoder|2.1 Transformer架构中Encoder的并行化]]
	- [[#22-transformerdecoder|2.2 Transformer架构中Decoder的并行化]]
    
- [[#3-transformer|3 Transformer的特征抽取能力]]
- [[#4-transformerseq2seq|4 为什么说Transformer可以代替seq2seq?]]
    
	- [[#41-seq2seq|4.1 seq2seq的两大缺陷]]
	- [[#42-transformer|4.2 Transformer的改进]]
...
## 1 Transformer的并行计算[[#1-transformer|¶]]
...
## 2 Transformer架构的并行化过程[[#2-transformer|¶]]

### 2.1 Transformer架构中Encoder的并行化[[#21-transformerencoder|¶]]
...
### 2.2 Transformer架构中Decoder的并行化[[#22-transformerdecoder|¶]]
...
## 4 为什么说Transformer可以代替seq2seq?[[#4-transformerseq2seq|¶]]

### 4.1 seq2seq的两大缺陷[[#41-seq2seq|¶]]
...
### 4.2 Transformer的改进[[#42-transformer|¶]]
