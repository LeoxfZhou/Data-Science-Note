...
- [[#_1|学习目标]]
- [[#1-bert-gpt-elmo|1 BERT, GPT, ELMo之间的不同点]]
- [[#2-bert-gpt-elmo|2 BERT, GPT, ELMo各自的优点和缺点]]
- [[#3|3 小结]]
...
## 1 BERT, GPT, ELMo之间的不同点[[#1-bert-gpt-elmo|¶]]
...
## 2 BERT, GPT, ELMo各自的优点和缺点[[#2-bert-gpt-elmo|¶]]
