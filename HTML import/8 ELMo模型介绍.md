...
- [[#2-elmo|2 ELMo的架构]]
	...
	- [[#21|2.1 总体架构]]
	- [[#22-embedding|2.2 Embedding模块]]
	- [[#23-lstm|2.3 两部分的双层LSTM模块]]
	- [[#24|2.4 词向量表征模块]]
    
- [[#3-elmo|3 ELMo的预训练任务]]
    
	- [[#31-elmo|3.1 ELMo的本质思想]]
	- [[#32-elmo|3.2 ELMo的预训练采用了典型的两阶段过程]]
...
### 2.2 Embedding模块[[#22-embedding|¶]]

ELMo最底层的词嵌入采用CNN对字符级进行编码, 本质就是获得一个静态的词嵌入向量作为网络的底层输入.

### 2.3 两部分的双层LSTM模块[[#23-lstm|¶]]
...
### 3.2 ELMo的预训练采用了典型的两阶段过程[[#32-elmo|¶]]
