...
suggested_target: "Notes/数据科学（Data Science）/01-编程基础（Programming）/02-C++ 编程（C++）/05-C++ 函数、回调与递归（Functions Callbacks and Recursion）.md"
operation: 新建
merge_target: null
---
...
本文跨三个来源合并函数基础、参数传递、函数指针、回调、重载、默认实参、内联和递归。
...
- `Processing/00-Inbox/数据科学（Data Science）/01-编程基础（Programming）/02-C++ 编程（C++）/指针与函数.md`
- `Processing/00-Inbox/数据科学（Data Science）/01-编程基础（Programming）/02-C++ 编程（C++）/函数进阶与内存管理.md`
- **建议目标位置（Suggested Target）**：`Notes/数据科学（Data Science）/01-编程基础（Programming）/02-C++ 编程（C++）/05-C++ 函数、回调与递归（Functions Callbacks and Recursion）.md`
