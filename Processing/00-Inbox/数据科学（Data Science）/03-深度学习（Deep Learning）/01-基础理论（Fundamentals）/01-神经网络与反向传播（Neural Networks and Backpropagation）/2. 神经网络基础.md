...
![[2. 神经网络基础-20260328152626058.png]]
...
![1663472645904](2.%20神经网络基础-20260328152615593.png)
...
![1663472675509](2.%20神经网络基础-20260328152614005.png)
...
![1663472703595](2.%20神经网络基础-20260328152615690.png)

ReLU 的函数图像、导数图像如下：

<img src='1734057447434.png' style="zoom:50%;"/>
...
- **随机初始化**
  - 均匀分布初始化：权重参数初始化从区间均匀随机取值，默认区间为（0，1）。可以设置为在(-$$1\over\sqrt{d}$$,$$1\over\sqrt{d}$$)均匀分布中生成当前神经元的权重，其中d为神经元的输入数量。
    ...
    ![1745673221974](2.%20神经网络基础-20260328152639894.png)
...
![[2. 神经网络基础-20260328152624848.png]]
...
- 模型参数的计算
  ...
  - 输入数据和网络权重是两个不同的事儿！对于初学者理解这一点十分重要，要分得清。
    ...
    ![[2. 神经网络基础-20260328152626292.png]]
...
![image-20200730153842351](2.%20神经网络基础-20260328152529159.png)

损失函数在不同的文献中名称是不一样的，主要有以下几种**命名方式**：

![[2. 神经网络基础-20260328152526110.png]]
...
![[2. 神经网络基础-20260328152536846.png]]
...
![[2. 神经网络基础-20260328152738573.png]]

上图中的交叉熵损失为：

![image-20200730161024749](2.%20神经网络基础-20260328152538263.png)

从概率角度理解，我们的目的是最小化正确类别所对应的预测概率的对数的负值(损失值最小)，如下图所示：

![[2. 神经网络基础-20260328152539904.png]]
...
![image-20200730162332710](2.%20神经网络基础-20260328152541440.png)
...
- L用来衡量真实值y与预测值$$\hat{y}$$之间差异性的损失结果。
  ...
  ![[2. 神经网络基础-20260328152550606.png]]
...
![image-20200730165058491](2.%20神经网络基础-20260328152542839.png)

曲线如下图所示：

![image-20200730165142553](2.%20神经网络基础-20260328152740023.png)
...
![image-20200730165213969](2.%20神经网络基础-20260328152532143.png)

曲线如下图所示：

![image-20200730165404271](2.%20神经网络基础-20260328152530556.png)
...
![image-20200730170635889](2.%20神经网络基础-20260328152533689.png)

其中：`𝑥=f(x)−y` 为真实值和预测值的差值。

![[2. 神经网络基础-20260328152535388.png]]
...
<img src="G:/BaiduNetdiskDownload/%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%E8%AE%B2%E4%B9%89/%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%E5%9F%BA%E7%A1%80html/02-%E7%A5%9E%E7%BB%8F%E7%BD%91%E7%BB%9C%E5%9F%BA%E7%A1%80/13.png" />
...
![[2. 神经网络基础-20260328152747892.png]]

**前向传播运算**：

![[2. 神经网络基础-20260328152752204.png]]
...
![[2. 神经网络基础-20260328152623455.png]]

导数（梯度）已经计算出来了，下面就是**反向传播与参数更新过程**：

![[2. 神经网络基础-20260328152624492.png]]

如果要想求**误差E对w1的导数**，误差E对w1的求导路径不止一条，这会稍微复杂一点，但换汤不换药，计算过程如下所示：

![[2. 神经网络基础-20260328152753726.png]]
...
![1735177998337](2.%20神经网络基础-20260328152556816.png)
...
![1734144867552](2.%20神经网络基础-20260328152614223.png)
...
![image-20220313172050673](2.%20神经网络基础-20260328152740309.png)

###  等间隔学习率衰减

等间隔学习率衰减方式如下所示：

![[2. 神经网络基础-20260328152738757.png]]
...
![[2. 神经网络基础-20260328152742940.png]]
...
![[2. 神经网络基础-20260328152629209.png]]
...
![05-01](2.%20神经网络基础-20260328152609510.png)
...
![image-20220517141847967](2.%20神经网络基础-20260328152624948.png)
...
![image-20220517143935599](2.%20神经网络基础-20260328152752509.png)
...
![1745856376465](2.%20神经网络基础-20260328152603005.png)
...
![1734255905857](2.%20神经网络基础-20260328152638230.png)
...
![1734256199295](2.%20神经网络基础-20260328152549321.png)
...
![1734256384162](2.%20神经网络基础-20260328152547520.png)
